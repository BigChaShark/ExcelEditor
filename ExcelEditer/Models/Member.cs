...
public partial class Member
{
    ...
    public string? ShopType2 { get; set; }

    public string? ShopType3 { get; set; }
    ...
    public int? Zone2Group { get; set; }

    public int? Zone3Group { get; set; }

    public int? Zone5Group { get; set; }
